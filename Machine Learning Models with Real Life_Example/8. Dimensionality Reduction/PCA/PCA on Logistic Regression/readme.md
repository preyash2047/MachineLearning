Logistic Classifier with Principal Component Analysis
<hr>
...
> Conclusion:
Logistic Classifier with Principal Component Analysis model is has given the accuracy of 80% where as Linear Regression without PCA has given 82%.
